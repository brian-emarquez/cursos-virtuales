...
import com.example.cursos.dto.CursoRequest;
import com.example.cursos.dto.CursoResponse;
...
public class CursoService {
    ...
    // Reutilizado por crear y actualizar
    private void copiarDatos(CursoRequest req, Curso curso) {
        ...
        if (req.activo() != null) {       // solo cambia si el cliente lo envió
